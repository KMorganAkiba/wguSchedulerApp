...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Landroidx/constraintlayout/solver/LinearSystem;->USE_BASIC_SYNONYMS:Z

    .line 39
    sput-boolean v1, Landroidx/constraintlayout/solver/LinearSystem;->SIMPLIFY_SYNONYMS:Z

    .line 40
    sput-boolean v1, Landroidx/constraintlayout/solver/LinearSystem;->USE_SYNONYMS:Z

    .line 41
    sput-boolean v1, Landroidx/constraintlayout/solver/LinearSystem;->SKIP_COLUMNS:Z
...
.method private final addRow(Landroidx/constraintlayout/solver/ArrayRow;)V
    ...
    iget-boolean v0, p0, Landroidx/constraintlayout/solver/LinearSystem;->hasSimpleDefinition:Z
    ...
    .line 660
    .local v1, "removedRow":Landroidx/constraintlayout/solver/ArrayRow;
    ...
    iput v6, v5, Landroidx/constraintlayout/solver/SolverVariable;->definitionId:I
    ...
    .line 654
    .end local v1    # "removedRow":Landroidx/constraintlayout/solver/ArrayRow;
...
.method private enforceBFS(Landroidx/constraintlayout/solver/LinearSystem$Row;)I
    ...
    .line 930
    sget-boolean v14, Landroidx/constraintlayout/solver/LinearSystem;->SKIP_COLUMNS:Z

    if-eqz v14, :cond_af

    .line 931
    iget-object v14, v12, Landroidx/constraintlayout/solver/ArrayRow;->variables:Landroidx/constraintlayout/solver/ArrayRow$ArrayRowVariables;
    ...
    .line 933
    iget-object v7, v12, Landroidx/constraintlayout/solver/ArrayRow;->variables:Landroidx/constraintlayout/solver/ArrayRow$ArrayRowVariables;

    invoke-interface {v7, v6}, Landroidx/constraintlayout/solver/ArrayRow$ArrayRowVariables;->getVariable(I)Landroidx/constraintlayout/solver/SolverVariable;

    move-result-object v7

    .line 934
    .local v7, "candidate":Landroidx/constraintlayout/solver/SolverVariable;
    ...
    invoke-interface {v15, v7}, Landroidx/constraintlayout/solver/ArrayRow$ArrayRowVariables;->get(Landroidx/constraintlayout/solver/SolverVariable;)F
    ...
    .line 942
    iget-object v2, v7, Landroidx/constraintlayout/solver/SolverVariable;->strengthVector:[F
    ...
    .line 946
    iget v10, v7, Landroidx/constraintlayout/solver/SolverVariable;->id:I
    ...
    .line 932
    .end local v5    # "k":I
    .end local v7    # "candidate":Landroidx/constraintlayout/solver/SolverVariable;
    .end local v15    # "a_j":F
    :cond_a6
    :goto_a6
    ...
    .line 962
    iget-object v7, v5, Landroidx/constraintlayout/solver/SolverVariable;->strengthVector:[F
    ...
    iput v9, v2, Landroidx/constraintlayout/solver/SolverVariable;->definitionId:I
...
.method private final optimize(Landroidx/constraintlayout/solver/LinearSystem$Row;Z)I
    ...
    invoke-virtual {v7, p0, v8}, Landroidx/constraintlayout/solver/SolverVariable;->updateReferencesWithNewDefinition(Landroidx/constraintlayout/solver/LinearSystem;Landroidx/constraintlayout/solver/ArrayRow;)V
...
.method public addConstraint(Landroidx/constraintlayout/solver/ArrayRow;)V
    ...
    .line 595
    iget-object v6, p0, Landroidx/constraintlayout/solver/LinearSystem;->mTempGoal:Landroidx/constraintlayout/solver/LinearSystem$Row;

    invoke-interface {v6, p1}, Landroidx/constraintlayout/solver/LinearSystem$Row;->initFromRow(Landroidx/constraintlayout/solver/LinearSystem$Row;)V

    .line 596
    iget-object v6, p0, Landroidx/constraintlayout/solver/LinearSystem;->mTempGoal:Landroidx/constraintlayout/solver/LinearSystem$Row;

    invoke-direct {p0, v6, v3}, Landroidx/constraintlayout/solver/LinearSystem;->optimize(Landroidx/constraintlayout/solver/LinearSystem$Row;Z)I

    .line 597
    iget v6, v4, Landroidx/constraintlayout/solver/SolverVariable;->definitionId:I
    ...
    .line 606
    iget-wide v8, v7, Landroidx/constraintlayout/solver/Metrics;->pivots:J

    add-long/2addr v8, v1

    iput-wide v8, v7, Landroidx/constraintlayout/solver/Metrics;->pivots:J

    .line 608
    :cond_77
    invoke-virtual {p1, v6}, Landroidx/constraintlayout/solver/ArrayRow;->pivot(Landroidx/constraintlayout/solver/SolverVariable;)V
    ...
    invoke-virtual {v1, p0, p1}, Landroidx/constraintlayout/solver/SolverVariable;->updateReferencesWithNewDefinition(Landroidx/constraintlayout/solver/LinearSystem;Landroidx/constraintlayout/solver/ArrayRow;)V
    ...
    invoke-interface {v1, p1}, Landroidx/constraintlayout/solver/Pools$Pool;->release(Ljava/lang/Object;)Z
...
.method public addEquality(Landroidx/constraintlayout/solver/SolverVariable;I)V
    ...
    iget v4, v1, Landroidx/constraintlayout/solver/SolverVariable;->synonymDelta:F
...
.method public addSynonym(Landroidx/constraintlayout/solver/SolverVariable;Landroidx/constraintlayout/solver/SolverVariable;I)V
    ...
    iget v1, p2, Landroidx/constraintlayout/solver/SolverVariable;->synonymDelta:F
    ...
    iget v1, p2, Landroidx/constraintlayout/solver/SolverVariable;->synonym:I

    aget-object p2, v0, v1

    .line 1317
    :cond_18
    iget-boolean v0, p1, Landroidx/constraintlayout/solver/SolverVariable;->isSynonym:Z
    ...
    iget v1, p1, Landroidx/constraintlayout/solver/SolverVariable;->synonymDelta:F
    ...
    iget v1, p1, Landroidx/constraintlayout/solver/SolverVariable;->synonym:I
    ...
    invoke-virtual {p1, p0, p2, v0}, Landroidx/constraintlayout/solver/SolverVariable;->setSynonym(Landroidx/constraintlayout/solver/LinearSystem;Landroidx/constraintlayout/solver/SolverVariable;F)V
...
.method public displayReadableRows()V
    ...
    iget-boolean v6, v3, Landroidx/constraintlayout/solver/SolverVariable;->isFinalValue:Z
    ...
    iget v4, v3, Landroidx/constraintlayout/solver/SolverVariable;->computedValue:F
    ...
    iget-boolean v6, v3, Landroidx/constraintlayout/solver/SolverVariable;->isSynonym:Z
    ...
    iget v7, v3, Landroidx/constraintlayout/solver/SolverVariable;->synonym:I

    aget-object v6, v6, v7

    .line 1072
    .local v6, "synonym":Landroidx/constraintlayout/solver/SolverVariable;
    ...
    iget v8, v3, Landroidx/constraintlayout/solver/SolverVariable;->synonymDelta:F
    ...
    .line 1068
    .end local v3    # "variable":Landroidx/constraintlayout/solver/SolverVariable;
    .end local v6    # "synonym":Landroidx/constraintlayout/solver/SolverVariable;
    :cond_b1
    add-int/lit8 v2, v2, 0x1
...
.method public getObjectVariableValue(Ljava/lang/Object;)I
    ...
    .line 417
    iget v2, v1, Landroidx/constraintlayout/solver/SolverVariable;->computedValue:F
...
.method public removeRow(Landroidx/constraintlayout/solver/ArrayRow;)V
    ...
    .line 691
    .local v1, "rowVariable":Landroidx/constraintlayout/solver/SolverVariable;
    iget v2, v1, Landroidx/constraintlayout/solver/SolverVariable;->definitionId:I
    ...
    .line 689
    .end local v1    # "rowVariable":Landroidx/constraintlayout/solver/SolverVariable;
    add-int/lit8 v0, v0, 0x1
